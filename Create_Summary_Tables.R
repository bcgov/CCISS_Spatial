...
dat <- st_read("FLPareas_Public_20250107/")
dat <- dat["ProjectNam"]
names(dat)[1] <- "ORG_UNIT"
temp <- st_transform(dat, 4326)
st_write(temp, "FLP_Boundary.shp")
...
for(dist_i in seq_along(dat$ORG_UNIT)[-1]){
